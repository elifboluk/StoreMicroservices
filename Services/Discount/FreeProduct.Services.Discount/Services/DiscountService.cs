...
namespace FreeProduct.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            return status > 0 ? Response<NoContent>.Success(204) : Response<NoContent>.Fail("İndirim kodu bulunamadı.", 404);
        }

        public async Task<Response<List<Models.Discount>>> GetAll()
        {
            var discounts = await _dbConnection.QueryAsync<Models.Discount>("Select * from discount"); // table name discount
        ...
        public async Task<Response<Models.Discount>> GetByCodeAndUserId(string code, string userId)
        {
            ...
            if (hasDiscount == null)
            {
                return Response<Models.Discount>.Fail("Tanımlı indirim kodu bulunamadı.", 204);
            }
        ...
        public async Task<Response<Models.Discount>> GetById(int id)
        {
            ...
            if (discount == null)
            {
                return Response<Models.Discount>.Fail("İndirim kodu bulunamadı.", 404);
            }
